...
<div class="wrapper fc-wrapper">
  <div class="container mt-3">
    ...
    <div class="row">
      <table class="table table-striped table-product_list">
          <thead>
            <tr>
            ...
            <?php if ( isset($attributes['products']) && !empty($attributes['products']) ): ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php else: ?>
                    <a href="<?php echo site_url('my-account/auction-manager?action=bidders&product_id='.$value['product_id']) ?>" class="btn btn-primary btn-sm">View</a>
                  <?php endif; ?>
                </td>
              </tr>
              <?php endforeach; ?>
