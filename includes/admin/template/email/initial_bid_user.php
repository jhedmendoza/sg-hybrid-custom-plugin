<?php
do_action( 'woocommerce_email_header', 'Successful initial bid', $attributes );
?>
<p>
	<?php
...
<p>
	<?php
	echo wp_kses_post( sprintf( __( 'You successfully created an initial bid to the product “<a href="%1$s"><strong>%2$s</strong></a>”. Please wait for the seller to approve your bid.', 'yith-auctions-for-woocommerce' ), $attributes->get_permalink(), $attributes->get_title() ) );
	?>
</p>
